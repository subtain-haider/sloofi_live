                        ...
                        <div class="nk-block">
                            <div class="nk-block-head">
                                <div class="nk-block-head-content">
                                    <h4 class="nk-block-title">All Packages</h4>
                                ...
                                <div class="card-inner">
                                    <table style="width: 100%;" class="datatable-init-export nk-tb-list nk-tb-ulist" data-export-title="Export" data-auto-responsive="false">
                                        ...
                                        <tr class="nk-tb-item nk-tb-head">
                                            ...
                                            <th class="nk-tb-col tb-col-md"><span class="sub-text">Assign Role</span></th>
                                            ...
                                            <tr class="nk-tb-item">
                                                <td class="nk-tb-col nk-tb-col-check">
                                                    <div class="custom-control custom-control-sm custom-checkbox notext">
                                                        <input type="checkbox" class="custom-control-input" id="{{$package->id}}">
                                                ...
                                                <td class="nk-tb-col">
                                                    <span>{{$package->role->name}}</span>
                                                </td>
{{--                                                <td class="nk-tb-col tb-col-md">--}}
{{--                                                    <span>{{$package->parent_category}}</span>--}}
{{--                                                </td>--}}
{{--                                                <td class="nk-tb-col tb-col-md">--}}
                                                ...
                                                <td class="nk-tb-col nk-tb-col-tools">
                                                    <ul class="nk-tb-actions gx-1">
                                                        <li class="nk-tb-action-hidden">
                                                            <a href="{{ route('package.edit',['id'=>$package->id]) }}" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="Edit">
                                                                <em class="icon ni ni-edit-fill"></em>
                                                            </a>
                                                        </li>
                                                        <li class="nk-tb-action-hidden">
                                                            <form action="{{ route('package.delete',['id'=>$package->id]) }}" method="POST">
                                                                @csrf
                                                                @method('DELETE')

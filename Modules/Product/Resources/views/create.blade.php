                        ...
                        <form method="POST" action="{{route('product.store')}}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col">
                                    ...
                                    <div class="preview-block">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="js-single custom-control-input"  name="published" value="1" checked id="customCheck1">
                                ...
                                <div class="col">
                                    <div class="preview-block">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="js-single custom-control-input"  name="featured" value="1" id="customCheck2">
                                            <label class="custom-control-label" for="customCheck2">Featured:</label>
                                        </div>
                                    </div>
                                    <!-- Featured: <input type="checkbox" class="js-single" name="featured" value="1" /> -->
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label"></label>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label"></label>
                                <div class="col">
                                    1 Piece Price*:<input type="number" class="form-control" placeholder="1 Piece Price" name="price_1" value="0" required>
                                </div>
                                <div class="col">
                                    100 Pieces Price*:<input type="number" class="form-control" placeholder="100 Piece Price" name="price_100" value="0" required>
                                </div>
                                <div class="col">
                                    1000 Pieces Price*:<input type="number" class="form-control" placeholder="1000 Piece Price" name="price_1000" value="0" required>
                                </div>
                                <div class="col">
